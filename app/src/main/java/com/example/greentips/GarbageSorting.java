...
public class GarbageSorting extends AppCompatActivity {
    ...
    public void organic(View v) {
        if (!display) {
            ...
            t_1.setPadding(40,0,40,0);
            t_1.setTextColor(Color.WHITE);
            t_1.setTextSize(fontsize);
            TextView t_2 = new TextView(getApplicationContext());
            t_2.setText("Once full, empty your reusable container into your green bin. Wash reusable container and place it back in your kitchen.");
            t_2.setPadding(40,0,40,0);
    ...
    public void glass(View v) {
        if (!display) {
            ...
            t_1.setTextSize(fontsize);
            TextView t_2 = new TextView(getApplicationContext());
            t_2.setText("Glass can be easily recycled and repurposed. They are taken to a plant where they are cleaned, " +
    ...
    public void plastic(View v) {
        if (!display) {
            ...
            t_1.setText("The majority of plastic materials are non-biodegradable. After the " +
                    ...
                    "environment. Recycle any plastics that have the universal recycling symbol on them.");
            t_1.setPadding(40,0,40,0);
            t_1.setTextColor(Color.WHITE);
            t_1.setTextSize(fontsize);
            AppCompatButton b = new AppCompatButton(getApplicationContext());
    ...
    public void paper(View v) {
        if (!display) {
            ...
            t_2.setText("Keep paper in a blue recycling bin at home so it is easy to transfer over " +
                    "to a bag on recycling day. Be sure to flatten cardboard before putting " +
    ...
    public void metal(View v) {
        if (!display) {
            ...
            t_1.setText("There are many reasons to start recycling your scrap metal. " +
                    ...
                    "earn extra money from items that would simply lie around your house otherwise.");
            t_1.setPadding(40,0,40,0);
            t_1.setTextColor(Color.WHITE);
            t_1.setTextSize(fontsize);
            TextView t_2 = new TextView(getApplicationContext());
            t_2.setText("You’ll then need to divide up ferrous (magnetic) and non-ferrous metals.");
            t_2.setPadding(40,0,40,0);
            t_2.setTextColor(Color.WHITE);
            t_2.setTextSize(fontsize);
            AppCompatButton b = new AppCompatButton(getApplicationContext());
    ...
    public void battery(View v) {
        if (!display) {
            ...
            mylayout.setOrientation(LinearLayout.VERTICAL);
            TextView t_1 = new TextView(getApplicationContext());
            t_1.setText("Place your single-use batteries in a zipper-style plastic bag beside your recycling box.");
            t_1.setPadding(40,0,40,0);
            t_1.setTextColor(Color.WHITE);
            t_1.setTextSize(fontsize);
            TextView t_2 = new TextView(getApplicationContext());
